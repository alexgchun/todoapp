...
function get_todos() {
    ...
    //if input is not null then JSON.parse will communicate with the web brower to make the task a JavaScript object
    if (todos_str !== null) {
...
//function adds the inputed task to get get_todos function array
function add() {
...
function show() {
    //this sets the task thta was retrieved as a variable
    var todos = get_todos();

    //this sets up each task as a ul
    var html = "<ul>";
//this displays a task to list in the order that it is inputed
...
//this cretes the functionality of removing a todo item from the array
function remove() {
